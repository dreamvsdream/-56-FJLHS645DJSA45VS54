...
//#endif
    static partial class AutoRegILType
    {
...
#if USE_HOT
            Assembly assembly = Assembly.LoadFile(ResourcesPath.dataPath + "/../Library/ScriptAssemblies/DyncDll.dll");
        ...
        static void BuildDelegate(Dictionary<System.Type, UseTypeInfo> csharpDelegate, Dictionary<System.Type, UseTypeInfo> hotTDic)
        {
            ...
            string file_path = string.Format("Assets/_GameMain/XIL/ILBinding/ILRegType_{0}.cs", file_suffix);
