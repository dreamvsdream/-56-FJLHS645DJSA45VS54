...
namespace AutoIL
{
    ...
    static class ILRegType
    {
        static public void RegisterFunctionDelegate(AppDomain appdomain)
        {
            ...
            appdomain.DelegateManager.RegisterFunctionDelegate<System.Threading.Tasks.Task, System.Int32>();
            appdomain.DelegateManager.RegisterFunctionDelegate<wxb.Generator.Parameter, System.Boolean>();
            ...
            appdomain.DelegateManager.RegisterFunctionDelegate<wxb.GenHotfixDelegate.Param, wxb.GenHotfixDelegate.Param, System.Int32>();
        ...
        static public void RegisterDelegateConvertor(AppDomain appdomain)
        {
            ...
            appdomain.DelegateManager.RegisterDelegateConvertor<System.Predicate<wxb.Generator.Parameter>>((act) =>
            {
                return new System.Predicate<wxb.Generator.Parameter>((obj) =>
                {
                    return ((System.Func<wxb.Generator.Parameter, System.Boolean>)act)(obj);
                });
            });

            appdomain.DelegateManager.RegisterDelegateConvertor<System.Comparison<wxb.Generator.Parameter>>((act) =>
            {
                return new System.Comparison<wxb.Generator.Parameter>((x, y) =>
                {
                    return ((System.Func<wxb.Generator.Parameter, wxb.Generator.Parameter, System.Int32>)act)(x, y);
                });
            });
            ...
            appdomain.DelegateManager.RegisterDelegateConvertor<System.Predicate<wxb.GenHotfixDelegate.Param>>((act) =>
            {
                return new System.Predicate<wxb.GenHotfixDelegate.Param>((obj) =>
                {
                    return ((System.Func<wxb.GenHotfixDelegate.Param, System.Boolean>)act)(obj);
                });
            });

            appdomain.DelegateManager.RegisterDelegateConvertor<System.Comparison<wxb.GenHotfixDelegate.Param>>((act) =>
            {
                return new System.Comparison<wxb.GenHotfixDelegate.Param>((x, y) =>
                {
                    return ((System.Func<wxb.GenHotfixDelegate.Param, wxb.GenHotfixDelegate.Param, System.Int32>)act)(x, y);
                });
            });
        ...
        static public void RegisterMethodDelegate(AppDomain appdomain)
        {
            ...
            appdomain.DelegateManager.RegisterMethodDelegate<wxb.Generator.Parameter>();
            appdomain.DelegateManager.RegisterMethodDelegate<UnityEngine.Object>();
            appdomain.DelegateManager.RegisterMethodDelegate<wxb.GenHotfixDelegate.Param>();
