...
namespace IL
{
    public partial class DelegateBridge
    {
        ...
        public void __Gen_Delegate_Imp11(object p0, bool p1)
        {
            using (var pObjs = new Objects(p0, p1))
            {
                methodInfo.Invoke(null, pObjs.objs);
        ...
        public bool __Gen_Delegate_Imp12(object p0, object p1)
        {
            using (var pObjs = new Objects(p0, p1))
            {
                bool result = default(bool);
        ...
        public void __Gen_Delegate_Imp14(bool p0, object p1, object p2)
        {
            using (var pObjs = new Objects(p0, p1, p2))
            {
                methodInfo.Invoke(null, pObjs.objs);
        ...
        public bool __Gen_Delegate_Imp15(float p0, float p1, float p2)
        {
            using (var pObjs = new Objects(p0, p1, p2))
            {
                bool result = default(bool);
        ...
        public UnityEngine.Rect __Gen_Delegate_Imp16(object p0)
        {
            using (var pObjs = new Objects(p0))
            {
        ...
        public UnityEngine.Rect __Gen_Delegate_Imp17(object p0, System.Nullable<System.Single> p1)
        {
            using (var pObjs = new Objects(p0, p1))
            {
                UnityEngine.Rect result = default(UnityEngine.Rect);
        ...
        public UnityEngine.ResourceManagement.AsyncOperations.IAsyncOperation<UnityEngine.SceneManagement.Scene> __Gen_Delegate_Imp19(object p0, UnityEngine.SceneManagement.LoadSceneMode p1)
        {
            using (var pObjs = new Objects(p0, p1))
            {
        ...
        public UnityEngine.ResourceManagement.AsyncOperations.IAsyncOperation<UnityEngine.GameObject> __Gen_Delegate_Imp20(object p0, object p1, bool p2)
        {
            using (var pObjs = new Objects(p0, p1, p2))
            {
        ...
        public UnityEngine.ResourceManagement.AsyncOperations.IAsyncOperation<UnityEngine.GameObject> __Gen_Delegate_Imp21(object p0, UnityEngine.Vector3 p1, UnityEngine.Quaternion p2, object p3)
        {
