...
//#endif
    static partial class AutoRegILType
    {
...
#if USE_HOT
			//wxb.L.Log(ResourcesPath.dataPath + "/Res/Code/DyncDll.dll");
			wxb.L.Log(ResourcesPath.dyncDllPath);
            //Assembly assembly = Assembly.LoadFile(ResourcesPath.dataPath + "/Res/Code/DyncDll.dll");
            Assembly assembly = Assembly.LoadFile(ResourcesPath.dyncDllPath);
        ...
        static void BuildDelegate(Dictionary<System.Type, UseTypeInfo> csharpDelegate, Dictionary<System.Type, UseTypeInfo> hotTDic)
        {
            ...
            string file_path = string.Format("Assets/_GameMain/XIL/Auto/ILRegType_{0}.cs", file_suffix);
